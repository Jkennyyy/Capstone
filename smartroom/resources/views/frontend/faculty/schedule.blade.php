...
.pg-header::before{
  ...
  background:rgba(245,197,24,.07);pointer-events:none;
}
.pg-header::after{
...
.stat-trend{
  font-size:.69rem;color:var(--text4);margin-top:3px;
...
.toolbar{
  ...
  box-shadow:0 1px 3px rgba(15,24,41,.04);
  animation:fadeUp .4s ease .12s both;
}
.search-wrap{
  display:flex;align-items:center;gap:8px;
  background:var(--bg);border:1.5px solid var(--border);
  border-radius:var(--r2);padding:8px 13px;flex:0 0 260px;
...
.search-wrap input{
  border:none;outline:none;background:transparent;
  font-family:var(--font-body);font-size:.82rem;color:var(--text);width:100%;
}
.search-wrap input::placeholder{color:var(--text4);}
.tb-spacer{flex:1;}
.sem-chip{
  display:flex;align-items:center;gap:7px;
  background:var(--blue-lt);border:1.5px solid var(--blue-border);
...
.day-section{
  animation:fadeUp .45s ease var(--d,.2s) both;
  background:linear-gradient(180deg,#ffffff 0%,#fbfdff 100%);
  border:1.5px solid var(--border);
  border-radius:16px;
  padding:14px;
  box-shadow:0 4px 16px rgba(15,24,41,.05);
  transition:transform .18s,box-shadow .18s,border-color .18s;
  min-height:100%;
}
.day-section:hover{
  transform:translateY(-2px);
  box-shadow:0 12px 28px rgba(15,24,41,.1);
  border-color:#cdd7ea;
}
...
.day-pill{
  ...
  box-shadow:0 4px 12px rgba(11,22,64,.22);
}
.day-info{flex:1;}
...
.cls-footer{
  ...
  padding-top:8px;border-top:1px solid var(--border);gap:8px;
}
.students-chip{
  display:flex;align-items:center;gap:5px;
...
.students-num{
  ...
  color:var(--card-text);font-size:.72rem;
}
...
.subj-hd-icon{
  ...
  background:var(--amber-lt);color:var(--amber);border:1px solid var(--amber-border);
  display:flex;align-items:center;justify-content:center;
}
...
.sc-code{
  ...
  background:var(--card-lt);color:var(--card-text);border:1px solid var(--card-border);
  letter-spacing:.04em;
}
...
<div class="sidebar">
  ...
  <ul class="sidebar-nav">
    <li><a href="#">
      <span class="nav-icon"><?=ic($icons,'home',15)?></span> Dashboard
    </a></li>
    <li><a href="#">
      <span class="nav-icon"><?=ic($icons,'door',15)?></span> Room
    </a></li>
    <li><a href="#" class="active">
      <span class="nav-icon"><?=ic($icons,'clock',15)?></span> Schedule
    </a></li>
    <li><a href="#">
      <span class="nav-icon"><?=ic($icons,'user',15)?></span> Profile
    </a></li>
  </ul>
  ...
  <ul class="sidebar-nav">
    <li><a href="#">
      <span class="nav-icon"><?=ic($icons,'robot',15)?></span> AI Recommendations
    </a></li>
    <li><a href="#">
      <span class="nav-icon"><?=ic($icons,'barchart',15)?></span> Reports
    </a></li>
  </ul>
  ...
  <div class="topbar">
    ...
    <div class="topbar-right">
      ...
      <div class="tb-profile">
        ...
        <div class="tb-avatar"><?=htmlspecialchars($faculty_initials)?></div>
        <span class="tb-chevron"><?=ic($icons,'chevdown',13)?></span>
      </div>
    </div>
  </div>
  ...
  <div class="content">
    ...
    <div class="pg-header">
      ...
      <div class="ph-actions">
        <button class="btn btn-white"><?=ic($icons,'print',13)?> Print</button>
        <button class="btn btn-yellow"><?=ic($icons,'export',13)?> Export</button>
      </div>
    </div>
